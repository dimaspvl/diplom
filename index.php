            ...
            <div class="storyContainer">
                <div class="storyCard">
                    ...
                    <div class="storyLine green">
                        ...
                        <h2 class="storyTitle">Завоевание первых клиентов</h2>
                        <h3 class="storyDescr">С помощью превосходного качества и уникального подхода к созданию саундтреков, BeatCup привлекла первых клиентов, что позволило компании укрепить свою репутацию и нарастить популярность на рынке.</h3>
                    </div>
                </div>
                <div class="storyCard">
                    <div class="storyLine">
                        <h2 class="year">2021</h2>
                        <h2 class="storyTitle">Расширение команды и партнерства</h2>
                        <h3 class="storyDescr">Расширению команды и установка стратегического партнерства с производителями видео и маркетинговыми агентствами для расширения своего влияния на рынке.</h3>
                    </div>
                    <div class="storyLine">
